...
public:
    ...
    void connect(Node *root)
    {
        ...
        //approach -
        /*
         1. level order traversal --> store two things
         a) number of nodes in one order
         b) the order of traversal of nodes from left to right

         2. assign the nextpointers accordingly
        */
        root->nextRight = NULL;
        queue<Node*> q;
        q.push(root);
